...
/*var watcher = new FilesizeWatcher('/var/tmp/filesizewatcher.test');
watcher.on('grew', function(grew){
	console.log('grew by ' + grew);
});

watcher.on('shrank', function(shrank){
	console.log('shrank by ' + shrank);	
});*/